...
// ========== Configuration ==========
const char* WIFI_SSID = "4GEE-Router-GKS7-2.4GHz";
const char* WIFI_PASS = "RrMxJERai7Xq";
...
const char* MQTT_USER = "passkey_01";
const char* MQTT_PASS = "125";

// Certificate - ADD YOUR CA CERT HERE
const char ROOT_CA_PEM[] = R"EOF(
-----BEGIN CERTIFICATE-----

7HC71rlHBrRdu4haMqk4nR90681W
-----END CERTIFICATE-----
